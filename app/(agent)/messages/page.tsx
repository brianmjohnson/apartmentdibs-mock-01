    ...
    messages: [
      {
        id: 'm1',
        sender: 'applicant',
        content: 'Hello, I submitted my application yesterday. I wanted to mention that I am very interested in this unit.',
        timestamp: '2025-11-15T14:00:00Z'
      },
      {
        id: 'm2',
        sender: 'agent',
        content: 'Thank you for your interest! Your application is currently being reviewed. We have received multiple applications for this unit.',
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: 'm2',
        sender: 'agent',
        content: 'Hi Sarah! The listing has received 189 views and 5 applications in the first week. Engagement is strong.',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 lg:grid-cols-3 h-[600px]">
        {/* Conversation List */}
        <Card className="border-2 border-foreground lg:col-span-1 flex flex-col">
        ...
        {/* Chat View */}
        <Card className="border-2 border-foreground lg:col-span-2 flex flex-col">
              ...
              <div className="p-4 border-t-2 border-foreground">
                <div className="flex gap-2">
                  <Textarea
                    ...
                    className="border-2 min-h-[60px] max-h-[120px] resize-none"
                    onKeyDown={(e) => {
                  ...
                  />
                  <Button
                    className="border-2 border-foreground h-auto"
