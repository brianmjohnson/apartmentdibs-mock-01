  ...
  return (
    <article>
      <header className="mb-8">
        ...
        <div className="mt-4 p-4 bg-muted/50 border-2 border-foreground">
          <p className="text-sm">
      ...
      {/* Table of Contents */}
      <nav className="mb-8 p-6 bg-muted/30 border-2 border-foreground">
        ...
        <ol className="space-y-2 text-sm">
          ...
          <li><a href="#your-rights" className="hover:underline">6. Your Rights (GDPR/CCPA)</a></li>
          ...
          <li><a href="#changes" className="hover:underline">9. Changes to Privacy Policy</a></li>
      ...
      <section id="introduction" className="mb-8">
        ...
        <p className="mb-4">
          ApartmentDibs, Inc. (&quot;ApartmentDibs,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) is committed to protecting
        ...
        <p>
          ...
          information as described in this Privacy Policy. If you do not agree with these
      ...
      <section id="information-we-collect" className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2 mb-6">
          ...
          <li><strong>Financial information:</strong> Income documentation, bank statements, credit card information for payments</li>
          <li><strong>Identity verification:</strong> Government-issued ID, Social Security Number (for background checks)</li>
          <li><strong>Employment information:</strong> Employer name, job title, work history</li>
          <li><strong>Rental history:</strong> Previous addresses, landlord references</li>
          <li><strong>Profile information:</strong> Photos, preferences, saved searches</li>
        </ul>
      ...
      <section id="how-we-use" className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong>Provide the Service:</strong> Create accounts, process applications, facilitate communications</li>
          <li><strong>Verify identity:</strong> Confirm your identity for background checks and fraud prevention</li>
          <li><strong>Process payments:</strong> Handle subscriptions and screening report fees</li>
          <li><strong>Improve the Service:</strong> Analyze usage patterns and develop new features</li>
          <li><strong>Communicate with you:</strong> Send notifications, updates, and promotional materials</li>
          <li><strong>Ensure compliance:</strong> Comply with legal obligations and enforce our Terms of Service</li>
          <li><strong>Protect users:</strong> Detect and prevent fraud, security threats, and abuse</li>
          <li><strong>Support fair housing:</strong> Implement compliance features and maintain audit trails</li>
        </ul>
      </section>
      ...
      <section id="information-sharing" className="mb-8">
        ...
        <p className="mb-4">
          ...
          or when necessary to protect our rights or the safety of users.
        </p>
      ...
      <section id="your-rights" className="mb-8">
        ...
        <Alert className="mb-6 border-2 border-foreground">
          <Shield className="h-4 w-4" />
          <AlertTitle>Your Privacy Rights</AlertTitle>
          <AlertDescription>
            Depending on your location, you may have specific rights under data protection
            laws such as the GDPR (European Union) or CCPA (California).
          </AlertDescription>
        </Alert>

        <h3 className="text-xl font-semibold mb-3">6.1 Rights Under GDPR (EU Residents)</h3>
        ...
        <h3 className="text-xl font-semibold mb-3">6.2 Rights Under CCPA (California Residents)</h3>
        ...
        <p>
          To exercise any of these rights, please contact us at privacy@apartmentdibs.com.
      ...
      <section id="data-retention" className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li><strong>Application records:</strong> 7 years (fair housing compliance)</li>
      ...
      <section id="childrens-privacy" className="mb-8">
        ...
        <p>
          ...
          us immediately at privacy@apartmentdibs.com, and we will take steps to delete such
          information.
        </p>
      </section>
      ...
      <section id="changes" className="mb-8">
        ...
        <p>
          ...
          the Service after any changes constitutes acceptance of the updated policy.
        </p>
      </section>
      ...
      <section id="contact" className="mb-8">
        ...
        <div className="p-4 bg-muted/30 border-2 border-foreground">
