    ...
    <article>
      <header className="mb-8">
        ...
        <div className="mt-4 p-4 bg-muted/50 border-2 border-foreground">
          <p className="text-sm">
            <strong>Note:</strong> These are sample terms for demonstration purposes only.
            Actual terms of service should be reviewed by legal counsel.
          </p>
        </div>
      </header>
      ...
      <nav className="mb-8 p-6 bg-muted/30 border-2 border-foreground">
        ...
        <ol className="space-y-2 text-sm">
          ...
          <li><a href="#accounts" className="hover:underline">3. User Accounts</a></li>
          <li><a href="#tenant-responsibilities" className="hover:underline">4. Tenant Responsibilities</a></li>
          <li><a href="#agent-landlord-responsibilities" className="hover:underline">5. Agent/Landlord Responsibilities</a></li>
          <li><a href="#prohibited-uses" className="hover:underline">6. Prohibited Uses</a></li>
          ...
          <li><a href="#indemnification" className="hover:underline">9. Indemnification</a></li>
          <li><a href="#termination" className="hover:underline">10. Termination</a></li>
          <li><a href="#governing-law" className="hover:underline">11. Governing Law</a></li>
          <li><a href="#changes" className="hover:underline">12. Changes to Terms</a></li>
      ...
      <section id="acceptance" className="mb-8">
        ...
        <p className="mb-4">
          Welcome to ApartmentDibs. By accessing or using our website, mobile application,
          or any other services we offer (collectively, the &quot;Service&quot;), you agree to be bound
        ...
        <p>
          ...
          (&quot;ApartmentDibs,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;). By using the Service, you represent that
      ...
      <section id="description" className="mb-8">
        ...
        <p className="mb-4">
          ApartmentDibs is a rental platform that connects tenants with landlords and agents
          while ensuring compliance with fair housing laws. Our Service includes:
        </p>
        ...
        <p>
          We do not own, manage, or control any rental properties listed on the Service.
          We are not a party to any rental agreements between tenants and landlords.
        </p>
      </section>
      ...
      <section id="accounts" className="mb-8">
        ...
        <p className="mb-4">
          ...
          an account, you agree to provide accurate, current, and complete information and to
        ...
        <p>
          ApartmentDibs offers different account types for tenants, agents, and landlords.
      ...
      <section id="tenant-responsibilities" className="mb-8">
        <h2 className="text-2xl font-bold mb-4">4. Tenant Responsibilities</h2>
      ...
      <section id="agent-landlord-responsibilities" className="mb-8">
        <h2 className="text-2xl font-bold mb-4">5. Agent/Landlord Responsibilities</h2>
        ...
        <p>
          Failure to comply with fair housing requirements may result in account suspension
          or termination and potential legal consequences.
        </p>
      </section>
      ...
      <section id="intellectual-property" className="mb-8">
        ...
        <h3 className="text-xl font-semibold mb-3">7.1 Our Property</h3>
        <p className="mb-4">
          The Service and its original content, features, and functionality are owned by
          ApartmentDibs and are protected by copyright, trademark, and other intellectual
          property laws.
        </p>
        ...
        <p className="mb-4">
          ...
          and display that content in connection with the Service.
        </p>
      ...
      <section id="indemnification" className="mb-8">
        ...
        <p>
          ...
          (including attorneys&apos; fees) arising from your use of the Service, your violation
      ...
      <section id="termination" className="mb-8">
        ...
        <p>
          ...
          also terminate your account at any time by contacting us. Certain provisions of
          these Terms will survive termination.
        </p>
      </section>
      ...
      <section id="changes" className="mb-8">
        ...
        <p className="mb-4">
          We reserve the right to modify or replace these Terms at any time. If we make
          material changes, we will provide notice through the Service or by other means.
        </p>
        <p>
