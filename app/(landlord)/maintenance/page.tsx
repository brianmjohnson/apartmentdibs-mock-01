    ...
    <Dialog>
      ...
      <DialogContent className="border-2 border-foreground max-w-2xl">
        ...
        <div className="space-y-4 py-4">
            ...
            <div>
              ...
              <div className="flex gap-2">
                {request.photos.map((photo, idx) => (
                  <div key={idx} className="w-20 h-20 bg-muted border-2 border-border flex items-center justify-center">
          ...
          {/* Tenant Contact */}
          <div>
            <h4 className="text-sm font-medium mb-2">Tenant Contact</h4>
    ...
    <div className="space-y-6">
      ...
      <Tabs value={filter} onValueChange={(v) => setFilter(v as MaintenanceFilter)}>
        <TabsList className="border-2 border-foreground">
          ...
          <TabsTrigger value="open" className="data-[state=active]:bg-foreground data-[state=active]:text-background">
            Open ({openCount})
          </TabsTrigger>
          <TabsTrigger value="in_progress" className="data-[state=active]:bg-foreground data-[state=active]:text-background">
            In Progress ({inProgressCount})
          </TabsTrigger>
          <TabsTrigger value="completed" className="data-[state=active]:bg-foreground data-[state=active]:text-background">
          ...
          {filteredRequests.length === 0 ? (
            ...
            <div className="grid gap-4">
              {filteredRequests.map((request) => (
                <Card key={request.id} className="border-2 border-foreground">
