    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          View and manage all leases across your properties
        </p>
      </div>
      ...
      <Tabs value={filter} onValueChange={(v) => setFilter(v as LeaseFilter)}>
        <TabsList className="border-2 border-foreground">
          ...
          <TabsTrigger value="active" className="data-[state=active]:bg-foreground data-[state=active]:text-background">
            Active ({activeCount})
          </TabsTrigger>
          <TabsTrigger value="expiring_soon" className="data-[state=active]:bg-foreground data-[state=active]:text-background">
            Expiring Soon ({expiringCount})
          </TabsTrigger>
          <TabsTrigger value="expired" className="data-[state=active]:bg-foreground data-[state=active]:text-background">
          ...
          {filteredLeases.length === 0 ? (
            ...
            <div className="grid gap-4">
              {filteredLeases.map((lease) => (
                <Card key={lease.id} className="border-2 border-foreground">
