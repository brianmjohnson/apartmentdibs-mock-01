        ...
        <CardContent>
          <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
            <div>
              ...
              <p className="text-muted-foreground">{formatCurrency(currentPlan.price)}/month</p>
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            {plans.map((plan) => (
              <div
                key={plan.name}
                className={`border-2 p-4 ${plan.current ? 'border-foreground bg-muted/50' : 'border-border'}`}
              >
