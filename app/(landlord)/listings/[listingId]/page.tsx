                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      <div className="flex gap-2 pt-2">
                        <Link href={`/listings/${listingId}/applicants?select=${applicant.id}`} className="flex-1">
                          <Button className="w-full border-2 border-foreground" size="sm">
                            <CheckCircle className="mr-2 h-4 w-4" />
                            Select Applicant
                          </Button>
                        </Link>
                        <Link href={`/listings/${listingId}/applicants?deny=${applicant.id}`} className="flex-1">
