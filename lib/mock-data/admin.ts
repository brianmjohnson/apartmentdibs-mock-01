...
export const mockSupportTickets: SupportTicket[] = [
  {
    ...
    description: "When I try to upload my pay stubs, the page shows an error message saying 'File type not supported'. I'm uploading PDF files which should be supported.",
    priority: "high",
    status: "open",
  ...
  },
  {
    ...
    description: "I submitted an application 3 days ago but the status is still showing as 'pending'. The agent told me they've already reviewed it.",
    priority: "medium",
    status: "in_progress",
  ...
  },
  {
    ...
    description: "I'm a freelancer and don't have traditional pay stubs. What documents can I use to verify my income?",
    priority: "low",
    status: "resolved",
  ...
  },
  {
    ...
    description: "My listings are not appearing on Zillow despite enabling syndication. This has been going on for 2 days.",
    priority: "urgent",
    status: "open",
    category: "Technical Issue",
  ...
  },
  {
    ...
    description: "I manage multiple properties and would like the ability to upload multiple listings at once via CSV or Excel file.",
    priority: "low",
    status: "closed",
...
export const mockTicketMessages: TicketMessage[] = [
  {
    ...
    content: "I submitted an application 3 days ago but the status is still showing as 'pending'. The agent told me they've already reviewed it.",
  ...
  },
  {
    ...
    content: "Hi James, thank you for reaching out. I'm looking into this issue for you. Can you please provide the listing address and your application ID?",
  ...
  },
  {
    ...
    sender: "support",
    senderName: "Alex Thompson",
    content: "Internal note: Checking with the agent to confirm they've updated the status on their end.",
...
export type ComplianceAlertType = 'potential_bias' | 'fair_housing_violation' | 'audit_request' | 'data_breach' | 'policy_violation';
...
export const mockComplianceAlerts: ComplianceAlert[] = [
  ...
  },
  {
    ...
    userId: "user-3",
    userName: "Emily Watson",
    description: "Agent's approval rate for applicants with 'foreign-sounding' names is 40% lower than average",
    status: "resolved",
    severity: "high",
...
export interface RecentActivity {
  id: string;
  type: 'user_signup' | 'flagged_content' | 'support_ticket' | 'compliance_alert' | 'listing_removed';
  title: string;
  description: string;
  timestamp: string;
  link?: string;
...
export function getComplianceSeverityColor(severity: 'low' | 'medium' | 'high' | 'critical'): string {
  switch (severity) {
    case 'critical':
      return 'bg-red-100 text-red-800 border-red-300';
    case 'high':
