...
export const mockApplicationDetails: Record<string, ApplicationDetail> = {
  'app-1': {
    ...
    beds: 2,
    baths: 1,
    propertyImage: '/images/listings/listing-1-1.jpg',
    sqft: 850,
    ...
    messages: [
      {
        ...
        message:
          "Thank you for your application! We've received all your documents and are currently reviewing them.",
  ...
  'app-2': {
    ...
    beds: 3,
    baths: 2,
    propertyImage: '/images/listings/listing-3-1.jpg',
    sqft: 1200,
    ...
    messages: [
      {
        ...
        message:
          "Great news! You've been shortlisted for the penthouse. We'd like to schedule a final viewing. Are you available this weekend?",
  ...
  'app-3': {
    ...
    beds: 2,
    baths: 2,
    propertyImage: '/images/listings/listing-5-1.jpg',
    sqft: 1000,
  ...
  'app-4': {
    ...
    beds: 1,
    baths: 1,
    propertyImage: '/images/listings/listing-2-1.jpg',
    sqft: 650,
    ...
    messages: [
      {
        ...
        message:
          "Thank you for your interest in 456 Park Ave. Unfortunately, we've decided to proceed with another applicant. We wish you the best in your apartment search.",
        timestamp: '2025-10-28T16:00:00Z',
      },
    ],
    denialReason:
      'The property has a strict no-pets policy. We encourage you to apply to our pet-friendly listings.',
  },
}
