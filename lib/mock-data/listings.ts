...
export const mockListings: Listing[] = [
  ...
  },
  {
    ...
    petFriendly: true,
    description:
      'Charming studio in Park Slope with excellent natural light. This well-maintained unit features an efficient layout, updated kitchen, and good closet space. Laundry in building and bike storage available. Ideal location near the F/G trains, Prospect Park, and 5th Avenue shopping and dining.',
    criteria: {
      incomeRatio: 3,
      minCredit: 650,
      maxEvictionYears: 7,
  ...
  },
  {
    ...
    petFriendly: true,
    description:
      "Luxurious 2-bedroom, 2-bath in Boerum Hill's newest development. This corner unit offers abundant light, premium finishes, and a private balcony. Features include a chef's kitchen with top-of-the-line appliances, spa-like bathrooms, and in-unit laundry. Full-service building with fitness center, rooftop terrace, and 24/7 concierge.",
    criteria: {
      incomeRatio: 40,
      minCredit: 700,
      maxEvictionYears: 5,
  ...
  },
  {
    ...
    petFriendly: true,
    description:
      'Spacious 1-bedroom with access to shared backyard in Crown Heights. This garden-level apartment features high ceilings, exposed brick, and a renovated kitchen with breakfast bar. Enjoy morning coffee in the peaceful backyard garden. Near the 2/5 trains and Franklin Avenue shops.',
    criteria: {
      incomeRatio: 3,
      minCredit: 660,
      maxEvictionYears: 7,
  ...
  },
  {
    ...
    petFriendly: false,
    description:
      'Classic Brooklyn loft-style 2-bedroom in Fort Greene. This character-filled apartment features soaring 12-foot ceilings, original exposed brick, and oversized windows. Modern updates include in-unit laundry and renovated kitchen. Walk to Fort Greene Park, BAM, and excellent local restaurants.',
    criteria: {
      incomeRatio: 3,
      minCredit: 680,
      maxEvictionYears: 7,
  ...
  },
  {
    ...
    petFriendly: true,
    description:
      'Stunning 2-bedroom, 2-bath in North Williamsburg with East River views. This sun-flooded corner unit offers an open floor plan, floor-to-ceiling windows, and premium finishes throughout. Building features a rooftop deck with Manhattan skyline views, fitness center, and bike storage. Steps from the ferry and waterfront parks.',
    criteria: {
      incomeRatio: 40,
      minCredit: 700,
      maxEvictionYears: 5,
  ...
  },
  {
    ...
    petFriendly: true,
    description:
      'Bright and airy 1-bedroom in up-and-coming Bushwick. Recently renovated with modern kitchen, updated bathroom, and new flooring throughout. Building features shared roof deck with city views. Great value in a vibrant neighborhood with easy access to the L and M trains.',
    criteria: {
      incomeRatio: 3,
      minCredit: 640,
      maxEvictionYears: 7,
...
export function filterListings(filters: {
  ...
  return mockListings.filter((listing) => {
    ...
    if (filters.beds && filters.beds.length > 0 && !filters.beds.includes(listing.beds))
      return false
    if (filters.baths && filters.baths.length > 0 && !filters.baths.includes(listing.baths))
      return false
    if (filters.petFriendly && !listing.petFriendly) return false
    if (filters.amenities && filters.amenities.length > 0) {
      const hasAllAmenities = filters.amenities.every(
        (amenity) =>
          listing.amenities.includes(amenity) || (amenity === 'Pet Friendly' && listing.petFriendly)
      )
