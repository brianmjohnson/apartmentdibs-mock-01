...
⚠️ **IMPORTANT DISCLAIMER**: THIS IS A DRAFT TEMPLATE ONLY. HAVE AN ATTORNEY REVIEW AND CUSTOMIZE THIS DOCUMENT BEFORE PUBLISHING. Terms of Service are legally binding contracts and must comply with applicable laws in your jurisdiction.
...
By accessing or using [COMPANY NAME] ("the Service," "we," "us," or "our") at [WEBSITE URL], you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the Service.

These Terms constitute a legally binding agreement between you ("you," "your," or "User") and [COMPANY NAME].
...
**Organization Accounts**: If you register on behalf of an organization, you represent that you have authority to bind that organization to these Terms.
...
You may delete your account at any time through account settings or by contacting us at [SUPPORT EMAIL].
...
"User Content" means any data, information, or materials you upload, submit, or create using the Service.
...
This license terminates when you delete your User Content or account (subject to backup retention periods).
...
The Service, including all content, features, and functionality, is owned by [COMPANY NAME] and protected by copyright, trademark, and other intellectual property laws.
...
**Payment Processing**: We use third-party payment processors (Stripe, PayPal, etc.)

**Billing Cycle**: [Monthly/Annual]

**Auto-Renewal**: Subscriptions automatically renew unless canceled

**Payment Methods**: Credit card, debit card, [other methods]

### 9.3 Price Changes

We may change prices with 30 days' notice. Price changes do not affect your current billing cycle.

### 9.4 Refunds

**Refund Policy**: [Specify refund terms, e.g., "30-day money-back guarantee" or "No refunds"]

**Cancellation**: You may cancel anytime. No refunds for partial months.

**Disputed Charges**: Contact us within 30 days at [BILLING EMAIL]
...
- We reserve the right to deny trial access
...
**Paid Plans**: Email support ([SUPPORT EMAIL]), [RESPONSE TIME SLA]

---

## 12. Data and Privacy

Your privacy is important to us. Our collection and use of personal information is governed by our Privacy Policy at [PRIVACY POLICY URL].

**Data Ownership**: You own your data.

**Data Export**: You can export your data at any time.

**Data Deletion**: When you delete your account, your data is deleted within 30 days (subject to legal retention requirements).
...
The Service may integrate with third-party services (OAuth providers, payment processors, etc.). Your use of third-party services is subject to their terms and privacy policies.

We are not responsible for third-party services or their practices.
...
The Service does not provide professional advice (legal, financial, medical, etc.). Content is for informational purposes only.

### 14.3 User Content Disclaimer

We do not endorse, verify, or take responsibility for User Content.
...
You agree to submit to the exclusive jurisdiction of courts in [CITY, STATE/COUNTRY].

### 17.3 Arbitration (Optional - Consult Attorney)

[If you want mandatory arbitration, specify arbitration terms, including AAA or JAMS rules, location, costs, and exceptions]

### 17.4 Class Action Waiver (Optional - Consult Attorney)
...
These Terms, together with our Privacy Policy, constitute the entire agreement between you and [COMPANY NAME].
...
We are not liable for delays or failures due to events beyond our reasonable control (natural disasters, war, pandemics, etc.).

### 19.6 Export Compliance

You agree to comply with export control laws and not export the Service to prohibited countries or individuals.

### 19.7 Government Users

If you are a U.S. government entity, the Service is "commercial computer software" under FAR 12.212.
...
- **Service**: [COMPANY NAME] platform at [WEBSITE URL]
- **User Content**: Data you upload or create using the Service
- **Account**: Your registered user account
- **Subscription**: Paid access to the Service
- **We/Us/Our**: [COMPANY NAME]
- **You/Your**: The user of the Service

---

**DRAFT VERSION - HAVE ATTORNEY REVIEW BEFORE PUBLISHING**

**Last Template Update**: 2025-11-16
**Maintained by**: Compliance Agent
**Legal Review Required**: Before first publication and annually thereafter
**State/Country Considerations**: [LIST JURISDICTIONS WHERE YOU OPERATE]
...
4. Consumer protection laws - CCPA, GDPR, local laws
5. Industry-specific regulations - HIPAA, COPPA, financial services, etc.
6. Warranty disclaimers - enforceable in your jurisdiction?
7. Choice of law and venue - appropriate for your business?
8. Refund policy - complies with consumer protection laws?
9. Auto-renewal - complies with state/federal auto-renewal laws?
